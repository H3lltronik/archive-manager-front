    ...
    <div class="body">
        <div class="body_header">
            ...
            <div class="body_header_buttons">
                <el-button type="text" :icon="Moon" @click="toggleTheme">ACTIVAR MODO OSCURO</el-button>

                <div class="order" v-show="showFilters">
                    <el-button :class="{'order--active': getOrderType == 'list'}" type="text" @click="() => changeOrderType('list')" :icon="List">LISTA</el-button>
                    <el-button :class="{'order--active': getOrderType == 'grid'}" type="text" @click="() => changeOrderType('grid')" :icon="Grid">CUADRICULA</el-button>
                </div>

                <el-button type="text" :icon="Filter" @click="toggleFilter">ORDENAR POR</el-button>
            </div>
        </div>
        <div class="body_content">
            <el-row :gutter="20">
                ...
                v-for="(item, index) in ((new Array(100)).fill(0).map(x => x))" :key="index">
...
const changeOrderType = (type: orderType) => store.commit('changeOrderType', type)
